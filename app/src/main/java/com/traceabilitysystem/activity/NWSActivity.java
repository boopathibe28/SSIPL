...
import com.traceabilitysystem.databinding.ActivityNwsSlittingBinding;
...
public class NWSActivity extends AppCompatActivity implements View.OnClickListener {
    ActivityNwsSlittingBinding binding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_nws_slitting);

        qrScan = new IntentIntegrator(NWSActivity.this);
    ...
    private void initialView() {
        ...
        binding.tvTitle.setText("NWS");
        binding.edtMachineName.setText("NWS");
    ...
    public void onClick(View view) {
        if (view == binding.imgBack){
            ...
            CommonFunctions.getInstance().newIntent(NWSActivity.this, ScannedBarcodeActivity.class, bundle, false, false);
        }
            ...
            if (binding.edtSSIPLID.getText().toString().trim().isEmpty()){
                CommonFunctions.getInstance().validationError(NWSActivity.this,"SSIPL ID is Empty");
            }
            else if (binding.edtWorkOrderTrimmed.getText().toString().trim().isEmpty()){
                CommonFunctions.getInstance().validationError(NWSActivity.this,"Work Order is Empty");
            }
            else {
                checkJobProcess();
            }
            ...
            if (binding.edtCoilNoFG.getText().toString().trim().isEmpty()){
                CommonFunctions.getInstance().validationError(NWSActivity.this,"Mother Coil ID is Empty");
            }
            else if (binding.edtSSIPLIDFG.getText().toString().trim().isEmpty()){
                CommonFunctions.getInstance().validationError(NWSActivity.this,"SSIPL ID is Empty");
            }
            else if (binding.edtThickFG.getText().toString().trim().isEmpty()){
                CommonFunctions.getInstance().validationError(NWSActivity.this,"Thick is Empty");
            }
            else if (binding.edtWidthFG.getText().toString().trim().isEmpty()){
                CommonFunctions.getInstance().validationError(NWSActivity.this,"Width is Empty");
            }
           /* else if (binding.edtLengthFG.getText().toString().trim().isEmpty()){
                CommonFunctions.getInstance().validationError(NWSActivity.this,"Length is Empty");
            }*/
            else if (binding.edtWeightFG.getText().toString().trim().isEmpty()){
                CommonFunctions.getInstance().validationError(NWSActivity.this,"Weight is Empty");
            }
            else {
                verificationDialog();
            }
            ...
            CommonFunctions.getInstance().newIntent(NWSActivity.this, ScrapEnterActivity.class, Bundle.EMPTY, false, false);
        }
    }

    private void verificationDialog() {
        final Dialog dialog = new Dialog(NWSActivity.this);
    ...
    private void fgApiCall(String input) {
        CommonApiCalls.getInstance().fgData(NWSActivity.this, input, new CommonCallback.Listener() {
            @Override
            public void onSuccess(Object body) {
                FGDataApiResponse apiResponse = (FGDataApiResponse) body;
                if (apiResponse.getStatus().toLowerCase().equals("success")){
                    CommonFunctions.getInstance().successResponseToast(NWSActivity.this, apiResponse.getMsg());
            ...
            public void onFailure(String reason) {
                ...
                CommonFunctions.getInstance().validationEmptyError(NWSActivity.this, reason);
            }
        });
    }
    ...
    private void fgWeightApiCall(String input) {
        CommonApiCalls.getInstance().fgDataCheck(NWSActivity.this, input, new CommonCallback.Listener() {
            @Override
            public void onSuccess(Object body) {
                ...
                if (apiResponse.getResult().equals("1")) {
                    ...
                    binding.lyoutFgWeight.setVisibility(View.GONE);
                    CommonFunctions.getInstance().validationError(NWSActivity.this, apiResponse.getMsg());
                }
            }
    ...
    private void checkJobProcess() {
        ...
        hrsSlittingJson.setMachine("NWS");
    ...
    private void apiCall(String input) {
        CommonApiCalls.getInstance().hrsSlitting(NWSActivity.this, input, new CommonCallback.Listener() {
            @Override
            public void onSuccess(Object body) {
